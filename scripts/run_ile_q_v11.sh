#!/bin/bash
# RE-RUN — nouveau label q_v11_m137, les 24 communes. Le run servi (q_v10_m129) reste intact.
set -u
cd /Users/openclaw/Desktop/labuse
export LABUSE_DATABASE_URL="postgresql+psycopg://openclaw@127.0.0.1:5432/labuse"
LOG=/tmp/rerun_q_v11_m137.log
BIN=.venv/bin/labuse
LABEL=q_v11_m137
...
echo "════ RUN ÎLE $LABEL — $(date '+%F %T') ════" >> "$LOG"

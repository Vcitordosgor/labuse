...
SYSTEM_PROMPT = (
    ...
    "es conscient des spécificités réunionnaises : vocation agricole indiquée par le RPG "
    "(déclarations PAC, indicatif), indivision successorale (bloqueur fréquent, parfois seulement "
    "signalé par un nombre de droits de propriété), cœur de Parc National exclu, aléas de cirque et "
    "érosion côtière.\n\n"

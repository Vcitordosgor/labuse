...
SOURCES: list[dict] = [
    ...
    dict(name="DVF / valeurs foncières", category="marche", provider="DGFiP / Cerema · Région ODS",
         ...
         legal_notes="Licence Ouverte + art. L.112 A LPF : interdiction de réidentifier / d'indexer — agréger, jamais nominatif. Attribution : « Source : DGFiP, Demandes de valeurs foncières (DVF), via data.regionreunion.com ».",

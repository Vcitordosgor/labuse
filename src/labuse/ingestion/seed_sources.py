...
SOURCES: list[dict] = [
    ...
    dict(name="SITADEL (autorisations d'urbanisme)", category="dynamique", provider="SDES (Dido)",
         ...
         legal_notes="Licence Ouverte. Pétitionnaires personnes MORALES seulement (physiques anonymisées à la source).",
    ...
    dict(name="Classement sonore ITT (Cerema)", category="reglement", provider="Cerema (Cartagène)",
         ...
         legal_notes="Open data Cerema. Classement en vigueur : arrêtés préfectoraux 14-15/12/2023.",
    ...
    dict(name="SUP — assiettes GPU (API Carto)", category="reglement", provider="IGN (Géoportail de l'urbanisme)",
         ...
         legal_notes="Licence Ouverte (GPU). Assiettes telles que téléversées par les gestionnaires — exhaustivité variable par catégorie.",
    ...
    dict(name="Recherche d'entreprises (DINUM)", category="economie", provider="DINUM (api.gouv.fr)",
         ...
         legal_notes="Open data DINUM (agrégat INSEE/RNE). RGPD : personnes morales ; signal INTERNE de priorisation (Score V), jamais un export nominatif de masse (règle d'archi #2).",
    ...
    dict(name="QPV 2024 (ANCT)", category="fiscal", provider="ANCT (Agence nationale cohésion des territoires)",
         ...
         legal_notes="Licence ouverte. Décret 2023-1314 (génération 2024, en vigueur 01/01/2024).",

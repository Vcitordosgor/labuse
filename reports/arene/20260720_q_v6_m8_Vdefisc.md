# Arène — q_v6_m8_Vdefisc vs q_v6_m8

**AVIS : REJETÉ**

Critère(s) en cause :
- RR@1158 non significativement supérieur (IC95 apparié de ΔRR : borne basse -0.80 ≤ 0)

_L'avis est indicatif : la bascule du run servi reste une décision humaine._  
_Généré 2026-07-20 20:30 UTC · seed 974 · RR@1158 · bootstrap n=1000 · année d'éval 2025._
...
- champion `q_v6_m8` : 431 663 parcelles · challenger `q_v6_m8_Vdefisc` : 431 663
...
- ΔRR = **+0.00** · IC95 apparié [-0.80 ; +0.91] · significatif (borne basse > 0) : **NON**
...
## 5. Churn — top-1158
- overlap : 1157/1158 (100%) · **churn 0%** (budget 25%) · 1 entrants / 1 sortants

## 6. Contrôle négatif — permutation
- RR@1158 sur labels permutés intra-année : **0.63** (attendu ≈ 1 ; s'en écarter = fuite/artefact).

## 7. Avis synthétique
**REJETÉ** — RR@1158 non significativement supérieur (IC95 apparié de ΔRR : borne basse -0.80 ≤ 0).

...
- [ ] **N°1 — RECHARGEMENT DE LA COUCHE BATIMENT : BLOQUANT PRODUIT (taux mesuré 04/08).** Échantillon aléatoire reproductible de 100 têtes servies sans indice : **38 % bâties franches** (IC 29-48, borne haute 59 % avec douteuses) → extrapolé **≈ 290 têtes servies bâties invisibles** sur 768 sans indice — ~1 tête servie sur 4 serait une parcelle déjà construite. Les lotissements récents (DK Saint-Paul, CD Saint-Benoît) sont surreprésentés ET aveugles : la couche est la plus fausse là où le scoring met ses têtes. Annexe : qa/dette4/echantillon100_classement.tsv. Conditionne : levée des 15 exceptions, arbitrage des 32 restantes, filtre client bâti. Recharger depuis la source à jour, par commune (Saint-Paul d'abord). RIEN corrigé avant arbitrage (consigne).

...
// A3 (post-revue) : « ingestion non tracée » remplacé par « à jour » (décision Vic, ton pro)
assert(/à jour/i.test(src) && !/ingestion non tracée/i.test(src), 'A3 : sources sans date → « à jour » (plus « ingestion non tracée »)')

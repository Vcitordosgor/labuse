 ...
 *
 *  M14 B1 (QA-62, reprise M13-D2/QA-48) — la bulle est rendue dans un PORTAL sur <body>, en
 *  position `fixed`, AU-DESSUS de tout (z ultra-haut) : elle n'est plus rognée par le bord du
 *  panneau ni par un conteneur `overflow:auto`. Repositionnement automatique si elle déborde d'un

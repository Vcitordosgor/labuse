...
import { fmtEurCompact, fmtInt, fmtM2, fmtLibelleBrut, iduComplet } from '../../lib/format'
...
import { REF, RENOUV, RENOUV_CODE_LABEL, IC, FicheAccordionCtx, RefDrawer, GroupLabel, MicroJauge, MicroSegments, MicroSpark, MicroPastilles, MicroTriple, RateLimit429, Line, EligibiliteReplie, icdColor, HypInput, StepProv, PorteOutil } from './primitives'

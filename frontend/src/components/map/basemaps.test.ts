...
describe('FIX-FONDS — fonds de carte', () => {
  ...
  it('U1 : aucun fond borné ; la sous-couche ortho monde porte la mer', () => {
    ...
    expect(ORTHO_MONDE.tiles[0]).toContain('LAYER=ORTHOIMAGERY.ORTHOPHOTOS&')   // la mosaïque, pas l'Express

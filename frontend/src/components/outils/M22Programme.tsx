    ...
    <>
      ...
      {d && (
        <>
          ...
          <div data-prog-count className="rounded-lg border border-[#4a3d6b] bg-[#171221] px-3 py-2">
            <p className="text-[13px] leading-snug text-txt">
              <b className="font-display text-lg font-bold" style={{ color: VIOLET }}>{fmt(d.n)}</b>{' '}

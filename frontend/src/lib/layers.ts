...
export const LAYER_INFO: Record<string, string> = {
  ...
  transport:
    'Les tracés des lignes de transport public (les 7 réseaux de l’île : Car Jaune, Citalis, Kar’Ouest, Alternéo, Carsud, Estival — source : GTFS officiels des autorités de transport, Licence Ouverte) et le téléphérique Papang en service à Saint-Denis (tracé OpenStreetMap). Les pôles d’échange sont désormais rattachés à la couche « Axes structurants » (les nœuds du réseau), qui les décrit. La ligne 2 « Zèl La Montagne », prévue pour 2029, n’a pas de tracé publié : elle n’est pas affichée.',
  axes:
  ...
  lignes_ht:
    'Les lignes électriques HAUTE TENSION (HTB) de l’île — le réseau de TRANSPORT 63 et 90 kV (source : BD TOPO IGN, tension indiquée, lignes aériennes uniquement). C’est une CONTRAINTE potentielle pour un projet (servitudes, reculs) : la servitude exacte n’est pas cartographiée en donnée ouverte et doit être vérifiée auprès du gestionnaire de réseau (EDF SEI). Sur la fiche d’une parcelle, LABUSE indique la distance à la ligne la plus proche. La moyenne tension (HTA) est une couche séparée, « Lignes moyenne tension (HTA) ».',
  lignes_mt:
    'Les lignes électriques MOYENNE TENSION (HTA, ~15-20 kV — la distribution) de l’île : 4 211 tronçons aériens et 15 269 souterrains, publiés par EDF sur son portail open data La Réunion (Licence Ouverte 2.0, géométrie ~février 2020, republiée le 16/10/2025). TRACÉ INDICATIF : EDF a réduit le contenu publié « pour renforcer la sécurité publique » (ni tension exacte, ni nom de ligne) — utile pour repérer un raccordement possible, mais ne remplace JAMAIS une DT-DICT avant travaux. Les positions des postes sources ne sont plus publiées (jeu vidé par EDF le 24/12/2025) : pas de couche postes.',
  arrets:
    'Les arrêts de transport en commun de l’île : les 9 956 quais des 7 réseaux (Car Jaune, Citalis, Kar’Ouest, Alternéo, Carsud, Estival — source : GTFS officiels, Licence Ouverte). Visibles à partir du zoom quartier. CLIQUABLES : le nom de l’arrêt, les lignes qui le desservent et le réseau. Les tracés des lignes sont la couche « Transport public ».',
  tcsp:
    'Le transport en commun en site propre (TCSP) : les voies dédiées aux bus réellement EN SERVICE sur l’île — boulevard sud de Saint-Denis, tronçons livrés à Saint-Pierre… (source : OpenStreetMap, trait plein) — et, en trait fin, les simples couloirs bus sur chaussée partagée (qui ne sont PAS un site propre au sens de la loi). Les stations desservies (dérivées des arrêts GTFS posés sur une voie en site propre) sont les points ronds. Ce que ça change : à moins de 800 m d’une station, le PLU ne peut pas exiger plus d’1 place de stationnement par logement (0,5 pour le logement social), si la qualité de la desserte le permet (art. L151-36 c. urb., loi du 26/11/2025) — la fiche parcelle porte ce fait. EN TRAVAUX (av. Rico Carpaye au Port, ESTI+ à Saint-Benoît) et EN PROJET (Réunion Express — tram-train régional, débat public jusqu’au 26/11/2026, carte des hypothèses de tracé sur debatpublic.fr/projet-train-reunion-express) : aucun tracé public exploitable — rien n’est dessiné à la main, la sentinelle surveille.',
  renouv:

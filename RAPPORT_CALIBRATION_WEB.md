...
| `marge_cible_pct` | **9 % du CA** | estimée ★ | [crédit mutuel](https://www.creditmutuel-immobilier.fr/fr/actualites/quelle-est-la-marge-d-un-promoteur-immobilier.html), [modelesdebusinessplan](https://modelesdebusinessplan.com/blogs/infos/marge-promoteur-immobilier) | Marge **brute** 20–40 % du CA, **nette** 7–15 % après frais de structure. Dans le bilan, **honoraires (12 %) et frais financiers (3 %) sont déduits séparément** (lignes ci-dessous) → `marge_cible_pct` = marge **nette** retenue **9 %**, milieu prudent de la fourchette nette 7–15 %. **★ à affiner** (sensibilité forte). |

-- Étape 2 — mouvements servi (q_v8_calibre) → q_v10_cosia_apres (max emprise)
...
FROM rev r JOIN parcel_p_score_v2 b ON b.parcelle_id=r.idu AND b.run_id='q_v10_cosia_apres'
GROUP BY 1,2 ORDER BY 1,3 DESC;
\echo '=== effectifs finaux ==='
SELECT tier, count(*) FROM parcel_p_score_v2 WHERE run_id='q_v10_cosia_apres' GROUP BY 1 ORDER BY 2;
